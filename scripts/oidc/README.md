...
1. Set GitHub variables `AZURE_CLIENT_ID`, `AZURE_SUBSCRIPTION_ID` and `AZURE_TENANT_ID`
...
- [Install GitHub CLI](https://cli.github.com) (latest version as of writing: `2.30.0`) - to set GitHub variables
...
- GitHub repository role `Admin` - to set GitHub environment variables
